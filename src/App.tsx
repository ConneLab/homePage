...
import { Building2, Users, Sparkles, ArrowRight, Github, Linkedin, Twitter } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#FAF7F2]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-semibold text-[#2A2522]">ConneLab</span>
            </div>
            <div className="hidden md:flex space-x-8">
              <a href="#services" className="text-[#2A2522]/80 hover:text-[#2A2522] transition-colors">サービス</a>
              <a href="#about" className="text-[#2A2522]/80 hover:text-[#2A2522] transition-colors">会社概要</a>
              <a href="#contact" className="text-[#2A2522]/80 hover:text-[#2A2522] transition-colors">お問い合わせ</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-[#2A2522] mb-12">サービス</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: <Sparkles className="w-8 h-8" />,
                title: "ウェブ開発",
                description: "最新技術を活用した高品質なウェブアプリケーションの開発"
              },
              {
                icon: <Building2 className="w-8 h-8" />,
                title: "システム構築",
                description: "スケーラブルで安全なシステムアーキテクチャの設計と実装"
              }
            ].map((service, index) => (
              <div key={index} className="bg-[#FAF7F2] p-8 rounded-2xl">
                <div className="text-[#2A2522] mb-4">{service.icon}</div>
                <h3 className="text-xl font-semibold text-[#2A2522] mb-2">{service.title}</h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#2A2522]/80 mb-4">
                ConneLab は、2025年に設立された新しい形のテクノロジーカンパニーです。
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-[#2A2522] mb-12">お問い合わせ</h2>
          <div className="max-w-xl mx-auto">
            <form className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-[#2A2522]">お名前</label>
                <input
                  type="text"
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-[#2A2522]">メールアドレス</label>
                <input
                  type="email"
                  id="email"
                  className="mt-1 block w-full rounded-md border-[#2A2522]/20 shadow-sm focus:border-[#2A2522] focus:ring-[#2A2522] bg-[#FAF7F2]"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-[#2A2522]">メッセージ</label>
                <textarea
                  id="message"
                  rows={4}
                  className="mt-1 block w-full rounded-md border-[#2A2522]/20 shadow-sm focus:border-[#2A2522] focus:ring-[#2A2522] bg-[#FAF7F2]"
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="md:text-right">
              ...
              <p className="text-white/80">© 2025 ConneLab. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
